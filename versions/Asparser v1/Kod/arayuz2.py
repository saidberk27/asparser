#DORTLU YAP ICIN DORDE BOLUNEBILIR SAYILAR KULLANILMALIDIR.UYARI YAP.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(630, 860)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(630, 860))
        MainWindow.setMaximumSize(QtCore.QSize(630, 860))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 10, 621, 848))
        ...
        self.gridLayout.addWidget(self.parti_line, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sinif_line, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.parti_eleman_line, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.size_line, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ulke_line, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_3, 16, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lot_line, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sa_line, 13, 1, 1, 1)
        MainWindow.setCentralWidget(self.centralwidget)

        self.menuBar = QtWidgets.QMenuBar(MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 630, 26))
        self.menuBar.setObjectName("menuBar")
        self.menu_lot = QtWidgets.QAction(self.menuBar)#qmenu'yu qaction yap,baslik olarak kalmasin.
        ...
        self.menuBar.addAction(self.menu_lot)#.menuAction'u bu hale getir QMENU- QACTION DONUSUMU
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_lot.setText(_translate("MainWindow", "Lot Numarası Oluştur"))#SET TITLE - SET TEXT YAP,QMENU QACTION DONUSUMU
    ...
    def tiklandi(self):
        ...
        fonksiyon.seriNoOlustur(ulkeInput,partiInput,sinifInput,partiElemanInput,saInput)
